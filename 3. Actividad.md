...
```bash
ng generate component juego-numeros
```

**¿Qué hace este comando?**
- Crea el componente en `src/app/juego-numeros/`
- Genera 4 archivos automáticamente:
  - `juego-numeros.ts` (lógica del componente)
  - `juego-numeros.html` (template HTML)
  - `juego-numeros.css` (estilos)
  - `juego-numeros.spec.ts` (tests)

---

## Paso 2: Crear el componente de inicio (home)
...
## Paso 4: Configurar el componente principal con navegación
...
- `http://localhost:4200/juego-numeros` → Tu juego de números
...
## Estilos sugeridos para `juego-numeros.css`:
